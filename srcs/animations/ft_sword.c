...
/*   Updated: 2026/06/13 10:30:39 by dminh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_draw_weapon(t_game *game, t_textures *sword)
{
	...
	game->sword_anim.start_x = W_WIDTH - (SWORD_SIZE * SWORD_SCALE)
		- SWORD_PADDING;
	game->sword_anim.start_y = W_HEIGHT - (SWORD_SIZE * SWORD_SCALE);
	y = 0;
	while (y < SWORD_SIZE * SWORD_SCALE)
	{
		x = 0;
		while (x < SWORD_SIZE * SWORD_SCALE)
		{
			tex_x = x / SWORD_SCALE;
			tex_y = y / SWORD_SCALE;
